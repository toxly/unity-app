    ...
    internal class deserializer
    {
                            ...
                            default:
                                {
									...
									{
										object vo =pi.getValue(o);

                                        oset = ParseDictionary((Dictionary<string, object>)v, globaltypes, pi.pt, vo);
									}
        ...
        private void ProcessMap(object obj, Dictionary<string, myPropInfo> props, Dictionary<string, object> dic)
        {
            foreach (KeyValuePair<string, object> kv in dic)
            {
                ...
                if (t == typeof(Guid))
				{
					p.setValue(obj, CreateGuid((string)o));
				}
            }
        }
